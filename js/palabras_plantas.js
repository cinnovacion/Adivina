function palabras_plantas () {
	return [
		{
			"palabra":["r","o","b","l","e"],
			"pista":"Mi contextura es fuerte, me usan en la construccion la industria y trabajo.",
			"significado":"Árbol de la familia de las fagáceas, de gran tamaño, hojas perennes, flores unisexuales y fruto amargo, llamado bellota, cuya madera es muy apreciada en carpintería por ser dura y compacta."
		},
		{
			"palabra":["e","u","c","a","l","i","p","t","o"],
			"pista":"Mis hojas sirven para medicamentos natural.",
			"significado":"Árbol con el tronco recto y la copa en forma de cono, las hojas duras y olorosas y las flores amarillas, que alcanza gran altura; se utiliza en repoblaciones forestales por su rápido crecimiento, sus hojas tienen propiedades medicinales, su corteza se utiliza en el curtido de pieles y con su madera se fabrica papel."
		},
	];
}
