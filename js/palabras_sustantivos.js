function palabras_sustantivos(){
	return [
		{
			"palabra":["j","u","g","u","e","t","e","s"],
			"pista":"Soy especial porque me obsequian en navidad y cumpleaños.",
			"significado":"es un objeto para jugar y entretener, generalmente destinado a niños (y niñas), adultos o ambos."
		},
		{
			"palabra":["c","a","s","a"],
			"pista":"El lugar donde viven las personas.",
