function palabras_verbos(){
	return [
		{
			"palabra":["c","a","n","t","a","r"],
			"pista":"Lo que hacen los integrantes de un coro.",
			"significado":"Producir sonidos armoniosos o emitir con su voz un sonido de animal, especialmente los pájaros y el gallo."
		},
		{
			"palabra":["b","a","i","l","a","r"],
			"pista":"Es lo que se hace en una escuela de danza.",
			"significado":"Ejecutar movimientos rítmicos con el cuerpo, brazos y pies."
		},
	];
}
/*
