function palabras_animales(){
	return [
		{
			"palabra":["p","e","r","r","o"],
			"pista":"Es el mejor amigo del hombre.",
			"significado":"Animales domesticos mas antiguos del mundo y el mejor amigo del hombre, era un pariente salvaje de los actuales lobos."
		},
		{
			"palabra":["g","a","t","o"],
			"pista":"Me gusta cazar Ratones.",
			"significado":"Animal intelingente, elegante, cariñoso, observador, independiente."
		},
		{
			"palabra":["o","s","o"],
			"pista":"Soy perezoso, y entre mas gordo mas hermoso.",
			"significado":"Es uno de los animales mas grandes, por lo general viven solos, su peso varia según la estacion del año."
		},
		{
			"palabra":["p","a","t","o","s"],
			"pista":"Tengo el pico aplanado y mis pies son palmeados y digo cuack cuack!",
			"significado":"Es un ave palmipeda porque posee unos pies palmeados."
		},
		{
			"palabra":["g","a","l","l","i","n","a","s"],
			"pista":"Me gusta poner huevos y me duermo temprano.",
			"significado":"Animal Omnivoro que se alimenta de vegetales ocmo de otros animales."
		},
		{
			"palabra":["p","a","l","o","m","a","s"],
			"pista":"Hago un nido, llevo mensajes, y me gusta estar en los parques.",
			"significado":"Es una de las aves que mas rapido vuela."
		},
	];
}
/*
