function palabras_valores(){
	return [
		{
			"palabra":["r","e","s","p","e","t","o"],
			"pista":"Cuando aceptas a los demas tal y como son.",
			"significado":"Admiración, obediencia que se hace a alguien."
		},
		{
			"palabra":["t","o","l","e","r","a","n","c","i","a"],
			"pista":"Es cuando se escucha y se acepta la opinion de los demas.",
			"significado":"Es  la aceptación de la diversas opiniones, sociales, culturales y religiosa."
		},
	];
}
/*
