function palabras_paises(){
	return [
		{
			"palabra":["e","s","p","a","ñ","a"],
			"pista":"Campeón del mundo 2010",
			"significado":"Se conoce como conquistadores españoles a los colonizadores españoles que actuaron en América, durante la llamada era de los descubrimientos, la cual siguió a la llegada de Cristóbal Colón en 1492 y no alcanzó a superar el siglo de duración."
		},
		{
			"palabra":["n","i","c","a","r","a","g","u","a"],
			"pista":"Soy puro pinolero!.",
			"significado":"El paisito de uno pues, allá, en la cintura de América, el continente."
		},
	];
}
/*
